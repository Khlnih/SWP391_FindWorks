...
<body>
                ...
                <div class="col-lg-4">
                    <div class="job_sumary">
                        ...
                        <div class="summery_body">
                            <ul>
                                <li><i class="ti-folder"></i> <span>Category</span> Web Design</li>
                                <li><i class="ti-user"></i> <span>Experience</span> 2-3 Years</li>
                                <li><i class="ti-ruler-pencil"></i> <span>Job Level</span> Senior</li>
                                <li><i class="ti-wallet"></i> <span>Salary</span> $3500-$4000</li>
                                <li><i class="ti-map-alt"></i> <span>Location</span> California, USA</li>
                                <li><i class="ti-time"></i> <span>Deadline</span> 20 July 2019</li>
                            </ul>
                            <div class="summery_footer">
                                <h4>Share</h4>
    ...
    <script src="js/jquery.slicknav.min.js"></n
