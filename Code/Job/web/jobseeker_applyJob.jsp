...
<body>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input_field">
                                        ...
                                        <textarea name="coverLetter" id="coverLetter" cols="30" rows="10" placeholder="Write your cover letter here..." required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="input_field">
                                        ...
                                        <div class="serach_cat d-flex justify-content-end mt-3">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="footer_widget">
                            ...
                            <p>
                                Finfind is a job board for the best and brightest in the tech industry.
                            </p>
    ...
    <script>
        // Add the following script to show the selected file name in the file input
