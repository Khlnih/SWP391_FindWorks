<%-- 
    ...
    Created on : May 28, 2025, 9:26:41 PM
    Author     : DELL
--%>
...
<body>
    <div class="form-container">
        <h2>Đăng ký tài khoản Jobseeker</h2>
        <form method="post" action="RegisterFreelancerServlet" onsubmit="return validateForm()">
            <div class="form-row">
                <div class="form-group">
                    <label for="lastName">Họ</label>
                    <input type="text" id="lastName" name="last_name" placeholder="Nhập họ">
                </div>
                <div class="form-group">
                    <label for="firstName">Tên</label>
                    <input type="text" id="firstName" name="first_name" placeholder="Nhập tên">
                </div>
            </div>
    ...
    <script>
        function validateForm() {
            ...
            // Validate phone only if it's not empty, as it's not marked as required in HTML
