                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h5 class="notification-title mb-1">
                                                <c:choose>
                                                    <c:when test="${notification.notificationType == 'ApplicationUpdate'}">
                                                        <i class="fas fa-file-alt text-info me-2"></i> Cập nhật đơn ứng tuyển
                                                    </c:when>
                                                    <c:when test="${notification.notificationType == 'JOB'}">
                                                        <i class="fas fa-briefcase text-success me-2"></i> Việc làm mới
                                                    </c:when>
                                                    <c:otherwise>
                                        ...
                                        <div class="notification-actions">
                                            <c:if test="${notification.isRead == 0}">
                                                ...
                                                <form action="ffavoriteController" method="POST" class="d-inline">
                                                    <input type="hidden" name="action" value="readFavo">
                                            ...
                                            <form action="ffavoriteController" method="POST" class="d-inline">
                                                    <input type="hidden" name="action" value="deleteFavo">
                                                    <input type="hidden" name="jobseekerID" value="${jobseeker.getFreelancerID()}">
                                                    <input type="hidden" name="notiID" value="${notification.notificationID}">
