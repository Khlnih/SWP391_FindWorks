...
<head>
    ...
    <style>
        ...
        .admin-header h2 { color: var(--text-color); font-weight: 700; font-size: 2.5rem; }
        ...
        .form-container h4 { color: var(--primary-color); margin-bottom: 20px; font-weight: 600; }
        ...
        .status-badge.active { background-color: #e4f8f0; color: #28a745; border: 1px solid #a3e9d0; }
        .status-badge.inactive { background-color: #fbe9e7; color: #dc3545; border: 1px solid #f9bdbb; }
        .action-menu-btn {
            background: none;
            border: none;
            cursor: pointer;
        ...
        .action-menu-btn:hover { background-color: #f0f0f0; color: #495057; }
        ...
        .dropdown-divider { height: 1px; background-color: #e9ecef; margin: 6px 0; }
        .action-menu-item {
            padding: 8px 16px;
            border: none;
            border-radius: 4px;
        ...
        .action-menu-item:hover { background-color: #f8f9fa; transform: translateX(2px); }
        .action-menu-item i { font-size: 14px; width: 18px; text-align: center; }
        .btn-delete-item { color: #dc3545; }
        .btn-delete-item:hover { background-color: #fff5f5; color: #c82333; }
            ...
            <form action="admin?action=addSkill" method="post" id="addSkillForm">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-1">
                        ...
                        <input type="number" class="form-control" id="expertiseId" name="expertiseId" min="1">
                    </div>
                    <div class="col-md-1">
