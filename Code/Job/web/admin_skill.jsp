...
<head>
    ...
    <style>
        ...
        body { font-family: 'Poppins', sans-serif; margin: 0; padding: 0; overflow-x: hidden; background: linear-gradient(135deg, var(--primary-color) 0%, var(--primary-dark) 100%); min-height: 100vh; }
        ...
        .admin-header h2 { color: var(--primary-color); font-weight: 700; font-size: 2.5rem; text-shadow: 2px 2px 4px rgba(0,0,0,0.1); }
        .data-table-container { background: var(--white); border-radius: 12px; padding: 24px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border: 1px solid rgba(0,0,0,0.05); transition: 0.3s ease; }
        .data-table-container:hover { transform: translateY(-5px); box-shadow: 0 8px 25px rgba(0,0,0,0.1); border-color: var(--primary-color); }
        .search-container { background: var(--white); padding: 20px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); margin-bottom: 30px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease; }
        .search-container:hover { box-shadow: 0 8px 25px rgba(0,0,0,0.1); border-color: rgba(0,123,255,0.2); }
        .search-container .form-label { font-weight: 500; color: var(--text-color); margin-bottom: 8px; display: block; font-size: 0.9rem; }
        .search-container .form-control, .search-container .form-select { height: 45px; border-radius: 8px; border: 1px solid #e0e0e0; transition: all 0.3s ease; font-size: 0.95rem; padding: 0.5rem 1rem; }
        .search-container .form-control:focus, .search-container .form-select:focus { border-color: var(--primary-color); box-shadow: 0 0 0 0.2rem rgba(0,123,255,0.25); }
        .search-container .btn { height: 45px; display: inline-flex; align-items: center; justify-content: center; font-weight: 500; transition: all 0.3s ease; padding: 0.5rem 1.25rem; font-size: 0.95rem; border-radius: 8px; }
        .search-container .btn i { margin-right: 8px; font-size: 1rem; }
        .search-container .btn-primary { background-color: var(--primary-color); border-color: var(--primary-color); }
        .search-container .btn-primary:hover { background-color: var(--primary-dark); border-color: var(--primary-dark); transform: translateY(-2px); box-shadow: 0 4px 12px rgba(0,123,255,0.3); }
        .search-container .btn-outline-secondary { border: 1px solid #dee2e6; color: #6c757d; }
        .search-container .btn-outline-secondary:hover { background-color: #f8f9fa; border-color: #adb5bd; color: #495057; transform: translateY(-2px); }
        .table { width: 100%; border-collapse: collapse; margin-bottom: 0; }
        .table th, .table td { padding: 15px; vertical-align: middle; border-bottom: 1px solid rgba(0,0,0,0.05); }
        .table th { background: var(--primary-light); color: var(--text-color); font-weight: 500; text-transform: uppercase; font-size: 0.875rem; }
        .table td { color: var(--text-color); }
        .action-buttons { display: flex; gap: 8px; } /* Reduced gap between action buttons */
        .action-btn { padding: 6px 12px; border-radius: 6px; text-decoration: none; color: var(--white); display: inline-flex; align-items: center; gap: 5px; transition: 0.3s ease; font-size: 13px; }
        .action-btn i { font-size: 13px; }
        .btn-edit { background: #ffc107; color: #212529;} /* Edit button */
        .btn-delete-skill { background: #dc3545; } /* Delete skill button (separate class) */
        .btn-edit:hover { background: #e0a800; transform: translateY(-2px); }
        .btn-delete-skill:hover { background: #c82333; transform: translateY(-2px); }
        ...
        .pagination .page-link:hover { background-color: var(--primary-light); color: var(--primary-color); }
        ...
        .add-skill-form { background: var(--white); padding: 20px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); margin-bottom: 30px; border: 1px solid rgba(0,0,0,0.05); }
        .add-skill-form h4 { color: var(--primary-color); margin-bottom: 20px; }
        ...
        @media (max-width: 768px) {
            ...
            .data-table-container, .add-skill-form, .search-container { padding: 15px; }
             .search-container .col-md-5, .search-container .col-md-4, .search-container .col-md-3 { margin-bottom: 10px; }
